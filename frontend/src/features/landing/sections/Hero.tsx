...
export function Hero() {
  return (
    <section id="top" className="relative overflow-hidden">
      ...
      <Container className="relative grid grid-cols-1 gap-16 pb-24 pt-12 md:pt-20 lg:grid-cols-12 lg:gap-10 lg:pb-32">
        <div className="min-w-0 lg:col-span-5 lg:pt-4">
          <p className="rise inline-flex items-center gap-2 rounded-full border border-line bg-card px-3 py-1 text-[12.5px] text-muted">
            <ShieldCheck className="size-3.5 text-accent-2" aria-hidden="true" />
            Built on the official WhatsApp Business Platform
          </p>

          <h1 className="rise rise-1 mt-6 font-display text-[2.55rem] font-semibold leading-[1.04] tracking-[-0.035em] text-balance sm:text-[3.3rem] lg:text-[3.6rem]">
          ...
          <ul className="rise rise-3 mt-10 grid gap-3 border-t border-line pt-6 text-[14px] sm:grid-cols-3 sm:gap-6 lg:grid-cols-1 lg:gap-3">
            {facts.map((fact) => (
