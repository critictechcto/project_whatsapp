...
from .models import AlertInboundMessage, AlertMessage, AlertRecipient, PendingSellerReply
...
@admin.register(AlertInboundMessage)
class AlertInboundMessageAdmin(admin.ModelAdmin):
    list_display = ("type", "from_wa_id", "outcome", "received_at", "created_at")
    list_filter = ("outcome", "type")
